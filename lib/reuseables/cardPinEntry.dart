...
class CardPinBottomSheet extends StatefulWidget {
  final TransactionBottomSheetDetails details;
  final Function(String pin) onButtonPressed;
  final int minusValue;

  const CardPinBottomSheet(
      {Key key, this.details, this.onButtonPressed, this.minusValue})
      : super(key: key);

  @override
  _CardPinBottomSheetState createState() =>
      _CardPinBottomSheetState();
}

class _CardPinBottomSheetState extends State<CardPinBottomSheet> {
  @override
